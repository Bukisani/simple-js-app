...
pokemonRepository.loadList().then(function () {
  pokemonRepository.getAll().forEach((t) => {
    pokemonRepository.addListItem(t);
  });
}),
  $('#myInput').keyup(function (t) {
    let e = $('input').val().toLowerCase();
    $('.group-list-item').each((t, o) => {
      '' === e || $(o).text().toLowerCase().indexOf(e) > -1
        ? $(o).show()
        : $(o).hide();
    });
  });
